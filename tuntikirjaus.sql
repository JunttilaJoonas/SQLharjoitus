...
--
-- Host: localhost    Database: tuntikirjaus
-- ------------------------------------------------------
...
INSERT INTO `kayttaja` VALUES (1,'Testi','Tuntinen','maalaamo','maalari'),(2,'Pekka','Pätevä','it','konsultti');
...
CREATE TABLE `tunnit` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pvm` date NOT NULL,
  `tunnit` float NOT NULL,
  `aihe` varchar(255) NOT NULL,
  `laskutettava` tinyint(1) DEFAULT '0',
...
INSERT INTO `tunnit` VALUES (1,'2018-07-04',7.5,'maalaus',1,1),(2,'2018-07-04',7,'selvitys',1,2);
...
-- Dump completed on 2018-07-05 10:00:29
